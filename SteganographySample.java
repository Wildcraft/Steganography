 ...
 *Class Steganography
 */
public class SteganographySample {

	public static void main(String[] args) {
		SteganographySample steganography = new SteganographySample();

		Boolean encodedStatus = steganography.encode(
		...
		if (encodedStatus) {
			System.out.println(steganography.decode(
					"C:\\Users\\Public\\Pictures\\Sample Pictures",
					"StegoDesert"));
		}
	}
